                  ...
                  if(isreSend){
                                ...
                                for (var i=0; i < vm.Chat.length; i++) {
                                     if(vm.Chat[i].messageId==extFrom.split("@")[1]){
                                         ...
                                         Vue.set(vm.Chat[i].messageBody, 'displayName',myMessageBody.displayName );
                                         break;
                                     }
                                };
                         }else{
...
function showMy(type,text,MyMessageId,para){
    ...
    if(type=="image"){
        ...
        getImgHeightLocal(data.messageBody, para);
...
$("#chat-box").on("mousedown mouseup touchstart", function(e){
 ...
 */
function getImgHeightLocal(obj, par){
    ...
    if(par === null){
        ...
        if(par.orientation == '6' || par.orientation == '8'){
            obj.width = par.height;
            obj.height = par.width;
        }else{
            obj.width = par.width;
