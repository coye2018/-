function downHtmlContentFn() {
    // '<p class="downwarp-progress"></p><p class="downwarp-tip">下拉刷新 </p>';
    return '<div class="down-loading"><img src="../img/downLoading.gif" /></div>';       
};

function htmlNodataFn() {
    // '<p class="upwarp-nodata">-- END --</p>'
    return '<p class="upwarp-nodata">-- 加载完毕 --</p>'
}

function emptyNoTipFn() {
    //"暂无相关数据~"
    return ''
}
