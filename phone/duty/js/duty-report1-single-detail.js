var vm = new Vue({
    ...
    methods: {
    	addcomment:function(){
            ...
            //Android
            if(platForm=="1"){
               appcan.window.open('duty-report1-single-add-comment','duty-report1-single-add-comment.html',2);
            }else{
               appcan.window.open({
                    name:'duty-report1-single-add-comment',
                    dataType:0,
                    data:'duty-report1-single-add-comment.html',
                    aniId:aniId,
                    type:1024
                }); 
            }
    	...
    	morecomment:function(){
    		if(vm.commentSum!=0){
                ...
                //Android
                if(platForm=="1"){
                   appcan.window.open('duty-report1-single-comment', 'duty-report1-single-comment.html', 2);
                }else{
                   appcan.window.open({
                        name:'duty-report1-single-comment',
                        dataType:0,
                        data:'duty-report1-single-comment.html',
                        aniId:aniId,
                        type:1024
                    }); 
                }
