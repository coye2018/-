...
(function ($) {
    ...
    appcan.ready(function() {
        ...
        appcan.frame.open({
            id:'ScrollContent',
            url:'duty-four-2-special-page.html',
            left:0,
            top: titleHeight,
            width: pageWidth,
        ...
        // 阴影toggle
        appcan.window.subscribe('duty-four-2-special-shade', function (type) {
            vm.shade = (type == 'hide' ? false : true);
        });
        
        // 关闭页面
        appcan.window.subscribe('duty-four-2-special-close', function () {
