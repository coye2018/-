...
;(function ($) {
    ...
    $('#nav-right').click(function () {
        ...
        //Android
        if (platForm == "1") {
            appcan.window.open('flight-accurate3.html', 'flight-accurate3.html', 2);
        } else {
            appcan.window.open({
                name: 'flight-accurate3.html',
                dataType: 0,
                data: 'flight-accurate3.html',
                aniId: aniId,
                type: 1024
            });
        }
    ...
    appcan.ready(function () {
        appcan.window.publish("retNum",123);
    ...
    console.log(typeof (appcan.locStorage.getVal("arr")));
    function downCallback() {
        ...
        var json = {
            ...
            // path: "http://10.10.11.175:9080/single/focFlightSecondController.do?focGetflightByCondition",
            data: {
    ...
    function getData(page) {
        ...
        var json = {
            ...
            // path: "http://10.10.11.175:9080/single/focFlightSecondController.do?focGetflightByCondition",
            data: {
                flightno:flightNum.flightNumber,
