...
(function($) {
    appcan.ready(function() {
        ...
        appcan.window.subscribe('task-comment-submit', function(msg){
...
function sendaj(){
    ...
    var json={
        ...
        data:{
            ...
            taskinfoid:appcan.locStorage.getVal("dataId"),
    ...
    ajaxRequest(json,function(data,e){
        if(e=="success"){
           appcan.window.publish("reloadTaskComment", "reloadTaskComment");
           var closeArr = ['task-commentpage'];
