...
(function($) {
    appcan.ready(function() {
        ...
        appcan.window.subscribe('notice-comment-submit', function(msg){
...
function sendaj(){
    ...
    ajaxRequest(json,function(data,e){
        if(e=="success"){
           appcan.window.publish("reloadNoticeComment", "reloadNoticeComment");
           var closeArr = ['notice-commentpage'];
