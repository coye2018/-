...
function distReceiveConfirm() {
    ...
    var json = {
        path: serverPath + 'focDutyProblemController.do?focIsMyProblem',
        data: {
            problemId: dataId,
            doMethods: escape(vm.text),
