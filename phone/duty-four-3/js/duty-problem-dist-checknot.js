...
//验收不通过, 提交数据
function distChecknotConfirm() {
    if(!isDefine(vm.text)){
        layerToast('请填写理由后再提交');
        return false;
    }
...
(function($) {
    appcan.ready(function() {
        appcan.window.subscribe('duty-problem-dist-checknot-modal', function(e) {
            pageClose();
        })
