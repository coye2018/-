...
(function ($) {
    ...
    appcan.ready(function() {
        ...
        appcan.window.openPopover({
            name: 'duty-problem-report-again-page',
            url: 'duty-problem-report-again-page.html',
            left: 0,
            top: titleHeight,
            width: pageWidth,
            height: pageHeight-titleHeight
        });
        resetPage({'header':'Header','content':'Page','name':'duty-problem-report-again-page'}); 
        
        // 阴影toggle
        appcan.window.subscribe('duty-problem-report-again-shade', function (type) {
            vm.shade = (type != 'hide');
        });
        
        // 关闭页面
        appcan.window.subscribe('duty-problem-report-again-close', function () {
